    ...
    try {
        ...
        if (data.status == "OK") {
            ...
            `, {
                ...
                return next(http_errors_1.default(400, error.message));
            }
        }
